...
public class EditToDo extends Application {
    ...
    public EditToDo(String username, String title, String description){
    ...
    public void start(Stage stage) {
        ...
        Button bt = new Button("Add");
            ...
            bt.setOnAction(event -> {
                ...
                if (tf.getText() != "" && tf1.getText() != "") {
                    int x = men.EditList(username, title, description, tf.getText(), tf1.getText(), cat);
                    if (x < 1) {
                        ToastNotification.showNotification(stage, "Error while trying to Edit");
                    } else {
    ...
    public void homeStarter(String username){
        Home home = new Home(username);
    }
}
